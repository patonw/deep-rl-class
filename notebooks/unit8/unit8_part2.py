...
# %%
# Otherwise vizdoom freezes loading the config
# !ln -sf .mypy/lib/python3.10/site-packages/vizdoom/scenarios/
...
hf_username = "patonw" # insert your HuggingFace username here
